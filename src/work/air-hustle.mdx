---
title: "Air Hustle"
description: "Designing the experience for a flight deals aggregator"
company: "Self-initiated"
headline: "Designing the experience for a flight deals aggregator"
team:
  - name: "KC"
...
<figure>
  <div class="overflow-hidden rounded-4xl bg-blue-100">
    <Image class="" src={userPersonasImage} alt="Inside each persona" />
  </div>
...
<figure>
  <div class="overflow-hidden rounded-4xl bg-blue-100">
    <Image class="!m-0" src={userFlowImage} alt="Repacking wireframes" />
  </div>
...
<figure>
  <div class="overflow-hidden rounded-4xl bg-blue-100">
    <Image class="!m-0" src={leoJourneyImage} alt="Repacking wireframes" />
  </div>
...
<figure>
  <div class="overflow-hidden rounded-4xl bg-blue-100">
    <Image class="!m-0" src={dmSansImage} alt="Typography choice" />
  </div>
...
<figure>
  <div class="overflow-hidden rounded-4xl bg-blue-100">
    <Image class="!m-0" src={ogSearchImage} alt="Original search design" />
  </div>
...
<figure>
  <div class="overflow-hidden rounded-4xl bg-blue-100">
    <Image class="!m-0" src={newSearchImage} alt="Tweaked search design" />
  </div>
...
<figure>
  <div class="overflow-hidden rounded-4xl bg-blue-100">
    <Image class="!m-0" src={fromSearchImage} alt="From search dropdown" />
  </div>
...
<figure>
  <div class="overflow-hidden rounded-4xl bg-blue-100">
    <Image class="!m-0" src={toSearchImage} alt="To search dropdown" />
  </div>
...
<figure>
  <div class="overflow-hidden rounded-4xl bg-blue-100">
    <Image class="!m-0" src={explorationflightCardImage} alt="Flight card" />
  </div>
...
<figure>
  <div class="overflow-hidden rounded-4xl bg-blue-100">
    <Image class="!m-0" src={filterImage} alt="Fly anywhere filter" />
  </div>
...
<figure>
  <div class="overflow-hidden rounded-4xl bg-blue-100">
    <Image class="!m-0" src={resultsImage} alt="Results card" />
  </div>
...
- **Conversion Rate** - Number of support tickets related to the flight booking process—high numbers might signal UX issues.
