...
A self-initiated UX/UI case study focused on simplifying the flight deals search experience. Inspired by Kayak and Skyscanner, the goal was to reduce friction and help users quickly find deals and book via third-party booking sites.

### Impact

In a real-word scenario I would test the flow of saerching a flight, exploring flights, selecting flights and then booking through a third party
