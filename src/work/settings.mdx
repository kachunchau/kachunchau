...
Redesigned Vero 2.0's settings area over 6 weeks. I led the end-to-end redesign. Our team of 5 (Head of Product, Product Designer, and 3 Engineers) with resources constraints had to move fast to close key feature gaps and remain competitive.
...
To align with business goals, some features were moved to phase 2, allowing us to prioritise core features for a faster launch. One of these decisions included removing the 'add new project' feature, enabling us to deliver a leaner MVP within the 6 week timeframe.
...
<div class="grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-10">
  <figure class="col-span-1">
    <Image
      class="!my-0 rounded-3xl bg-cyan-100"
      src={dataFeedsImage}
      alt="Data feeds"
    />
