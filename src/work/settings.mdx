...
<figure className="-mx-16">
  <Image
    className="rounded-4xl bg-yellow-50"
...
<div className="-mx-16 grid grid-cols-2 gap-10">
  <figure className="!my-0">
    <Image
      className="rounded-3xl outline outline-black/5"
      src={netlifyImage}
...
<figure className="-mx-16">
  <Image
    className="rounded-4xl bg-cyan-50"
...
<div className="-mx-16 grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-10">
  <figure className="col-span-1 !my-0 md:col-span-2">
    <Image
      className="rounded-3xl bg-cyan-50"
      src={settingsSidebarsImage}
      alt="Settings sidebar exploration"
    />
    <figcaption>Settings sidebar exploration</figcaption>
  </figure>
  <figure className="col-span-1 !my-0">
    <Image
      className="rounded-3xl bg-cyan-50"
...
<div className="-mx-16 grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-10">
  <figure className="col-span-1 !my-0">
    <div className="overflow-hidden rounded-3xl bg-cyan-50">
      <Image
...
<figure className="-mx-16">
  <div className="overflow-hidden rounded-4xl bg-yellow-50">
    <Image
