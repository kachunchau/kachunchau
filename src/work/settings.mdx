...
In Vero 2.0, the settings experience was fragmented and hard to navigate. Users struggled to manage projects, and user settings without getting lost. I led the redesign of the entire settings UI to make it easier to use, more consistent, and ready to scale.
...
To inform those decisions, the Head of Product collaborated closely with the Customer and Success teams to surface feedback. Their experience helped us identify recurring pain points and edge cases that might not have been obvious.

In parallel, the Head of Product worked with the founder to conduct a comprehensive audit of all existing user-level and project-level settings. This was also to decide which settings to migrate over from the Vero 1.0 to Vero 2.0 and which to deprecate.
