...
Redesigned Vero 2.0's settings area over eight weeks (originally scoped for six) I led the end-to-end redesign. Our team of 5 (Head of Product, Product Designer, and 3 Engineers) with budget and time constraints had to move fast to close key feature gaps and remain competitive.
